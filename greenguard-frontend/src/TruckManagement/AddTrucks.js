      ...
      <div className="addTruck-outerDiv">
        ...
        <div className="addTruck-innerDivR">
          ...
          <form className="addTruck-formlayout" onSubmit={sendData}>
            ...
            <button data-testid="truck-submit" type="submit" className="addTruck-btn addTruck-btnPrimary">Submit</button>
            <button data-testid="truck-cancel" type="button" className="addTruck-btn addTruck-btnSecondary" onClick={() => navigate("/truck")}>Cancel</button>
          </form>
        </div>
      </div>
    </div>
